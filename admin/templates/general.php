        ...
        <div class="ds-blocks-container">
            ...
            <div class="ds-row clearfix ds-row-equal-height">
                <div class="ds-block ds-col ds-col-6 mt-2">
                    ...
                    <div class="pt-2 pr-2 pb-2 pl-2<?php echo (isset($_GET['ds_support_request']) && $_GET['ds_support_request'] === 'sent' ? ' ds-success' : ''); ?>">
                        <?php if(isset($_GET['ds_support_request']) && $_GET['ds_support_request'] === 'sent'){ ?>
                            <div class="ds-success">
                                <h2><?php _e('Thank you for your feedback.'); ?></h2>
                                <p><?php _e('You have successfully created a support ticket.'); ?></p>
                            </div>
                        <?php } else{ ?>
                            <form action="<?php echo esc_url(admin_url('admin-post.php')); ?>" method="POST">
                                ...
                                <div class="ds-row clearfix border-bottom border-grey pb-1 pt-1">
                                    <label class="ds-col ds-col-3 ds-2col"><?php _e('Email'); ?>:</label>
                                    <div class="ds-col ds-col-9">
                                        <input required class="ds-col-12" type="text" name="ds_email" value="" placeholder="Your email address" />
                                    </div>
                                </div>
                                <div class="ds-row clearfix border-bottom border-grey pb-1 pt-1">
